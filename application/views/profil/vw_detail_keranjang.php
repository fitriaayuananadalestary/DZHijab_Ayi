    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <table class="table">
                ...
                <tbody>
                    <form action="<?= base_url('Utama/pesanan'); ?>" method="POST" enctype="multipart/form-data">
                        <?php
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $us['jumlah']; ?></td>
                                <td><?= $us['total']; ?></td>
                                <td><a href="<?= base_url('Utama/delkeranjang/') . $us['id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></a></td>
                            </tr>
                            <input type="hidden" name="hijab[]" value="<?= $us['id_hijab']; ?>">
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <select name="pembayaran" id="pembayaran" class="form-control">
                                    ...
                                    <option value="BRI">BRI - 782182171921123</option>
                                    <option value="MANDIRI">MANDIRI - 7821188764</option>
                                    <option value="BNI">BNI - 89178291</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
